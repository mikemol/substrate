...
WORKLIST = [
    ...
    {"sym": "⊙.oct", "desc": "C3 ladder: 𝕆-nonassociativity rung — exhibit (x·y)·z ≠ x·(y·z) at level 3 via the ≈#-⊥ projection pattern (mirrors mul-noncomm-ℍ). Completes the CD ladder ℂ-comm/ℍ-noncomm/𝕆-nonassoc/𝕊-ZD. Clean/achievable", "done": ("manual",)},
    {"sym": "⊙.morton", "desc": "C3 DEEP cell + GENERATOR of the grading cluster: the F₂ⁿ-graded SIGN-COCYCLE from the CD tower (eᵢ·eⱼ = ε(i,j)·e_{i⊕j}; the 2-cocycle identity; Morton=trivial ε, CD=nontrivial). New F₂ⁿ index + sign extraction — a multi-module arc. Builds on Cocycle.agda/MultiscaleOctonionLoop", "done": ("manual",)},
