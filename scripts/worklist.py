...
WORKLIST = [
    ...
    {"sym": "⊙.morton", "desc": "C3 DEEP cell + GENERATOR of the grading cluster. FOUNDATION done ([.idx] CayleyDickson.Cocycle: F₂ⁿ basis map e + index-XOR (zipWith _xor_) + ℂ cocycle). FOUNDATION + ≈#-SETOID done ([.idx] basis map e/index-XOR; [.setoid] ≈#-refl/sym/trans + neg/conj-zero#). FOUNDATION + ≈#-SETOID + conj-on-basis + ≈#-CONGRUENCES done ([.idx]/[.setoid]/[.conj]/[.cong]). OPEN (the recursive product law, all infra now in hand): mul-zero# → the explicit ε + the 4-case index-XOR induction (eᵢ·eⱼ ≈# ε·e_{i⊕j}) → 2-cocycle identity → Morton(trivial ε)-vs-CD(nontrivial). ⟹ C2/C4/C7 [.grade]", "done": ("manual",)},
