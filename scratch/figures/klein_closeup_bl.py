...
# Interior (concave) faces glow faintly — a soft inner light that bounces into
# the seams where the facets diverge; the exterior stays dark reflective gold.
B.polys(polys, B.material("#E69F00", rough=0.45, emission=0.05,
