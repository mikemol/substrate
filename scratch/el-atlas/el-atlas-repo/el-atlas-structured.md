...
- [The radial witness mode](#the-radial-witness-mode)
- [The zero-divisor witness mode](#the-zero-divisor-witness-mode)
...
*Perspective visibility — ADJ (executed, S_3ed20b0e9c22 configs):*
...
*Perspective visibility — IDC (executed, S_3ed20b0e9c22 configs):*
...
## The radial witness mode

**RDW — The radial witness mode** (§5.9; theory-threads §14 (T2)). At the sedenion rung, norm multiplicativity fails on pairs that are NOT zero divisors — the radial failure mode strictly exceeds the ZD mode.


*Perspective visibility — RDW (executed, S_3ed20b0e9c22 configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| V | V | V | V | V | V | V | V | V | V | V | V | P | V | V | V |

*Cross-reference — RDW:* depends on —; required by ['D4C', 'GCX', 'NGL', 'NVE', 'NVL', 'PHS', 'RAD', 'RLS', 'SWF', 'SWP', 'T53', 'TWN', 'V4I', 'ZDG']; independent of 12 claims (ADJ, BAL, CDC, CRS, PUR…).


## The zero-divisor witness mode

**ZDW — The zero-divisor witness mode** (§5.9; theory-threads §14 (T2)). Every zero divisor at the sedenion rung is a norm-failure witness (N(xy)=0 below N(x)N(y)>0), and they exist — the contained witness mode.


*Perspective visibility — ZDW (executed, S_3ed20b0e9c22 configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| V | V | V | V | V | V | V | V | V | V | V | V | P | V | V | V |

*Cross-reference — ZDW:* depends on —; required by ['D4C', 'GCX', 'NGL', 'NVE', 'NVL', 'PHS', 'RAD', 'RLS', 'SWF', 'SWP', 'T53', 'TWN', 'V4I', 'ZDG']; independent of 12 claims (ADJ, BAL, CDC, CRS, PUR…).
...
*Separation ledger BAL–CDC:* separated-in-S_3ed20b0e9c22 (41472 truth-separators); separated (adj; identical-frames) @ S_v2 (characteristic-break basis).


*Perspective visibility — BAL (executed, S_3ed20b0e9c22 configs):*
...
*Separation ledger CDC–GCX:* separated-in-S_3ed20b0e9c22 (27648 truth-separators); separated, 27648 truth — the sighting is not a restatement @ S_f117b7f53a8e (v3.5 first form, same caveat); separated, 27648 truth @ S_2738ddb8c926 (v3.5a).


*Perspective visibility — CDC (executed, S_3ed20b0e9c22 configs):*
...
*Verdict (S_3ed20b0e9c22, exhaustive): EXPRESSIBILITY-INTRINSIC — zero separators; co-movement 156672/156672 = 1.00; but NVE is never F anywhere in the space: a theorem, truth-stable wherever statable. Mutual constitution at the statability level, one-way at the truth level: interventions de-state the theorem rather than falsify it. ∀-over-declared-spaces; open-by-design.*

*Separation ledger NVE–NVL:* separated-in-S_3ed20b0e9c22 (6144 truth-separators); separated, 6144 truth @ S_f117b7f53a8e (v3.5 first form, same caveat); separated, 6144 truth @ S_2738ddb8c926 (v3.5a).


*Perspective visibility — D4C (executed, S_3ed20b0e9c22 configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | V | V | P | P | P | P | P | V | P | P | F | P | P | P | V |

*Perspective visibility — NVE (executed, S_3ed20b0e9c22 configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | V | V | P | P | P | P | P | V | P | P | V | P | P | P | V |

*Perspective visibility — TWN (executed, S_3ed20b0e9c22 configs):*
...
*Cross-reference — TWN:* depends on ['GCX', 'NGL', 'NOE', 'RAD', 'RDW', 'SWF', 'SWP', 'V4I', 'ZDG', 'ZDW']; required by ['GCX', 'NGL', 'NVL', 'PHS', 'RAD', 'RLS', 'SWF', 'SWP', 'T53', 'V4I', 'ZDG']; independent of 10 claims (ADJ, BAL, CDC, CRS, PUR…).
...
*Verdict (S_3ed20b0e9c22, exhaustive): EXPRESSIBILITY-INTRINSIC — zero separators; co-movement 110592/110592 = 1.00; but GCX, RAD is never F anywhere in the space: a theorem, truth-stable wherever statable. Mutual constitution at the statability level, one-way at the truth level: interventions de-state the theorem rather than falsify it. ∀-over-declared-spaces; open-by-design.*

*Separation ledger GCX–SWP:* separated-in-S_3ed20b0e9c22 (0 truth-separators); unseparated in truth, 0/18432; kind counts carry the blanket-guard semantics @ S_f117b7f53a8e (165888, v3.5 first form — central complex V-guard overrode declared knob support; Break-2 coeff rows artifactual; retrospective R-V35); unseparated in truth 0/18432; theorem-cluster member @ S_2738ddb8c926 (165888, v3.5a corrected).


*Perspective visibility — GCX (executed, S_3ed20b0e9c22 configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | P | P | P | P | P | P | P | P | P | P | V | P | P | P | V |

*Perspective visibility — RAD (executed, S_3ed20b0e9c22 configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | P | P | P | P | P | P | P | P | P | P | V | P | P | P | V |

*Perspective visibility — ZDG (executed, S_3ed20b0e9c22 configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | P | P | P | P | P | P | P | P | P | P | F | P | P | P | V |

*Cross-reference — GCX:* depends on ['NGL', 'RDW', 'SWF', 'TWN', 'ZDW']; required by ['D4C', 'NGL', 'NVE', 'NVL', 'PHS', 'RLS', 'SWF', 'SWP', 'T53', 'TWN', 'V4I']; independent of 11 claims (ADJ, BAL, CDC, CRS, PUR…).

*Cross-reference — RAD:* depends on ['NGL', 'RDW', 'SWF', 'TWN', 'ZDW']; required by ['D4C', 'NGL', 'NVE', 'NVL', 'PHS', 'RLS', 'SWF', 'SWP', 'T53', 'TWN', 'V4I']; independent of 11 claims (ADJ, BAL, CDC, CRS, PUR…).

*Cross-reference — ZDG:* depends on ['NGL', 'RDW', 'SWF', 'TWN', 'ZDW']; required by ['D4C', 'NGL', 'NVE', 'NVL', 'PHS', 'RLS', 'SWF', 'SWP', 'T53', 'TWN', 'V4I']; independent of 11 claims (ADJ, BAL, CDC, CRS, PUR…).
...
*Verdict (S_3ed20b0e9c22, exhaustive): EXPRESSIBILITY-INTRINSIC — zero separators; co-movement 147456/147456 = 1.00; but NGL is never F anywhere in the space: a theorem, truth-stable wherever statable. Mutual constitution at the statability level, one-way at the truth level: interventions de-state the theorem rather than falsify it. ∀-over-declared-spaces; open-by-design.*


*Perspective visibility — NGL (executed, S_3ed20b0e9c22 configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | V | P | P | P | P | P | P | V | P | P | V | P | P | P | V |

*Perspective visibility — V4I (executed, S_3ed20b0e9c22 configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | V | P | P | P | P | P | P | V | P | P | F | P | P | P | V |

*Cross-reference — NGL:* depends on ['GCX', 'NOE', 'RAD', 'RDW', 'SWF', 'SWP', 'TWN', 'ZDG', 'ZDW']; required by ['D4C', 'GCX', 'NVE', 'NVL', 'PHS', 'RAD', 'RLS', 'SWF', 'SWP', 'T53', 'TWN', 'ZDG']; independent of 10 claims (ADJ, BAL, CDC, CRS, PUR…).
...
*Characteristic-break coincidence with ['D4C', 'GCX', 'NGL', 'NVE', 'RAD', 'SWF', 'SWP', 'TWN', 'V4I', 'ZDG'] (shared break in the dep digraph); separated in-space — see ledger.*


*Perspective visibility — NOE (executed, S_3ed20b0e9c22 configs):*
...
*Characteristic-break coincidence with ['D4C', 'GCX', 'NGL', 'NOE', 'NVE', 'RAD', 'SWP', 'TWN', 'V4I', 'ZDG'] (shared break in the dep digraph); separated in-space — see ledger.*


*Perspective visibility — SWF (executed, S_3ed20b0e9c22 configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | V | P | P | P | P | P | P | P | P | P | V | P | P | P | P |

*Cross-reference — SWF:* depends on ['GCX', 'NGL', 'NOE', 'RAD', 'RDW', 'SWP', 'TWN', 'ZDG', 'ZDW']; required by ['D4C', 'GCX', 'NGL', 'NVE', 'NVL', 'PHS', 'RAD', 'RLS', 'SWP', 'T53', 'TWN', 'V4I', 'ZDG']; independent of 10 claims (ADJ, BAL, CDC, CRS, PUR…).
...
*Characteristic-break coincidence with ['D4C', 'GCX', 'NGL', 'NOE', 'NVE', 'RAD', 'SWF', 'TWN', 'V4I', 'ZDG'] (shared break in the dep digraph); separated in-space — see ledger.*


*Perspective visibility — SWP (executed, S_3ed20b0e9c22 configs):*
...
*Separation ledger CRS–NOE:* separated-in-S_3ed20b0e9c22 (55296 truth-separators); unseparated-in-S_v3 @ S_v3 (9 knobs, no basis_def); separated (basis_def='singular') @ S_v2 (characteristic-break basis + basis_def probe).


*Perspective visibility — CRS (executed, S_3ed20b0e9c22 configs):*
...
*Separation ledger PR2–PRO:* separated-in-S_3ed20b0e9c22 (0 truth-separators); 0 truth-separators; 4096 kind-separators (PRO's guard keys on L1) @ S_94763a8b62ea (v3.3).


*Perspective visibility — PR2 (executed, S_3ed20b0e9c22 configs):*
...
*Verdict (S_3ed20b0e9c22, exhaustive): EXPRESSIBILITY-INTRINSIC — zero separators; co-movement 129024/129024 = 1.00; but PRO is never F anywhere in the space: a theorem, truth-stable wherever statable. Mutual constitution at the statability level, one-way at the truth level: interventions de-state the theorem rather than falsify it. ∀-over-declared-spaces; open-by-design.*
...
*Perspective visibility — PRO (executed, S_3ed20b0e9c22 configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | V | V | P | V | P | P | P | P | P | P | P | P | P | P | P |

*Perspective visibility — PUR (executed, S_3ed20b0e9c22 configs):*
...
*Verdict (S_3ed20b0e9c22, exhaustive): TRUTH-INTRINSIC — zero separators of any kind; co-movement 124416/124416 = 1.00. Closure-under-break: every perturbation breaks the loop coherently, with kind-structure inside the co-movement (e.g. noisy lock: U vs F). ∀-over-declared-spaces; strengthens with each space survived; never closes.*
...
*Perspective visibility — L26 (executed, S_3ed20b0e9c22 configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | V | P | P | P | P | P | P | P | P | F | P | P | P | P | P |

*Perspective visibility — LOC (executed, S_3ed20b0e9c22 configs):*
...
*Perspective visibility — RLS (executed, S_3ed20b0e9c22 configs):*
...
*Perspective visibility — T53 (executed, S_3ed20b0e9c22 configs):*
...
*Separation ledger PHS–TWN:* separated-in-S_3ed20b0e9c22 (2304 truth-separators); SEPARATED: 768 truth-separators (the phase is the twist AS SEEN AGAINST the section) @ S_94763a8b62ea (v3.3).


*Perspective visibility — PHS (executed, S_3ed20b0e9c22 configs):*
...
**Order-free semiring parsing** [SWF] — The order-free face of SWP (counting, inside, inside×outside, conflation): extends verbatim over ℂ — the first EXTENDS stance, earned by its named breaker. *(Layer 1; theory-threads §8; retrospective R-V35)*

**Semiring-weighted parsing** [SWP] — One chart, pluggable semiring: the carrier semiring carries the SPPF's packed multiplicity; probability is the positive-rail section, Viterbi the idempotent pinning; inside×outside is the zipper product. *(Layer 1; theory-threads §2/§8/§9 (S7/S12/S13))*
...
**The Noether pairings** [NOE] — The squeeze conserves mass; the common translation conserves bias — the two charges of the pair's symmetry flows. *(Layer 1; §11.8, OB-7)*
...
**The braided V₄ (D₄)** [D4C] — Composed reading licenses the swap; ⟨negate-one, swap⟩ = D₄, the central extension of V₄ by the reversible twist [N,S] = −id. *(Layer 1; Theorem 5.4, Remark 5.5; expr-intrinsic circle member)*
...
**The crossbar** [CRS] — (mass, bias) = (E⁺+E⁻, E⁺−E⁻) is an invertible change of basis on the pair. *(Layer 2; §4)*
...
**The radial witness mode** [RDW] — At the sedenion rung, norm multiplicativity fails on pairs that are NOT zero divisors — the radial failure mode strictly exceeds the ZD mode. *(Layer 0; §5.9; theory-threads §14 (T2))*
...
**The third codec sighting** [GCX] — GALAXY's W ↔ ASPF's log-decode: the exponential codec is exact on the rank-sum quotient, and the quotient genuinely collides — GALAXY is a one-mode decode of the ASPF carrier. *(Layer 1; corpus-sweep §6 (S4); §5.8; expr-intrinsic circle member)*

**The twist** [TWN] — The level conjugation pair anticommutes by a central, reversible sign — the cocycle of the doubling interface; trivial in characteristic 2. *(Layer 1; §5.9, Theorem 5.4; expr-intrinsic circle member)*
...
**The zero-divisor witness mode** [ZDW] — Every zero divisor at the sedenion rung is a norm-failure witness (N(xy)=0 below N(x)N(y)>0), and they exist — the contained witness mode. *(Layer 0; §5.9; theory-threads §14 (T2))*

**The ∨E bridge** [NVE] — Proof-by-cases is the single/double pin split/join expansion; the Wheatstone bridge reads the case-bias the join forgets; classical ∨E lives on the balance manifold. *(Layer 1; §5.7e; nedge-decomposition §8 (S8/S9); expr-intrinsic circle member)*
...
| CDC | 1 | BAL | BAL | — |
| CRS | 2 | NOE, SWP | — | — |
| PUR | 2 | D4C, NOE, NVE, NVL, PRO, SWP | NVL, PR2, PRO | PRO ≡ PUR |
| PRO | 2 | D4C, NOE, NVE, NVL, PUR, SWP | NVL, PR2, PUR | PRO ≡ PUR |
| LOC | 2 | L26, NOE, RLS, SWP | L26, PHS, RLS, T53 | L26 ≡ LOC |
| L26 | 2 | LOC, NOE, RLS, SWP | LOC, PHS, RLS, T53 | L26 ≡ LOC |
| T53 | 3 | GCX, L26, LOC, NGL, NOE, RAD, RDW, RLS, SWF, SWP, TWN, V4I, ZDG, ZDW | — | — |
| V4I | 1 | GCX, NGL, NOE, RAD, RDW, SWF, SWP, TWN, ZDG, ZDW | D4C, NGL, NVE, NVL, PHS, RLS, T53, TWN | NGL ≡ V4I |
| D4C | 1 | GCX, NGL, NOE, NVE, RAD, RDW, SWF, SWP, TWN, V4I, ZDG, ZDW | NVE, NVL, PHS, PR2, PRO, PUR, TWN | D4C ≡ NVE ≡ TWN |
| PHS | 3 | D4C, GCX, L26, LOC, NGL, NOE, NVE, RAD, RDW, RLS, SWF, SWP, TWN, V4I, ZDG, ZDW | — | — |
| RLS | 2 | GCX, L26, LOC, NGL, NOE, RAD, RDW, SWF, SWP, TWN, V4I, ZDG, ZDW | L26, LOC, PHS, T53 | — |
| NOE | 1 | SWP | CRS, D4C, L26, LOC, NGL, NVE, NVL, PHS, PR2, PRO, PUR, RLS, SWF, SWP, T53, TWN, V4I | — |
| TWN | 1 | D4C, GCX, NGL, NOE, NVE, RAD, RDW, SWF, SWP, V4I, ZDG, ZDW | D4C, GCX, NGL, NVE, NVL, PHS, RAD, RLS, SWF, SWP, T53, V4I, ZDG | D4C ≡ NVE ≡ TWN |
| RAD | 1 | GCX, NGL, RDW, SWF, TWN, ZDG, ZDW | D4C, GCX, NGL, NVE, NVL, PHS, RLS, SWF, SWP, T53, TWN, V4I, ZDG | GCX ≡ RAD ≡ ZDG |
| ZDG | 1 | GCX, NGL, RAD, RDW, SWF, TWN, ZDW | D4C, GCX, NGL, NVE, NVL, PHS, RAD, RLS, SWF, SWP, T53, TWN, V4I | GCX ≡ RAD ≡ ZDG |
| PR2 | 2 | D4C, NOE, NVE, NVL, PRO, PUR, SWP | NVL | — |
| NGL | 1 | GCX, NOE, RAD, RDW, SWF, SWP, TWN, V4I, ZDG, ZDW | D4C, GCX, NVE, NVL, PHS, RAD, RLS, SWF, SWP, T53, TWN, V4I, ZDG | NGL ≡ V4I |
| NVL | 2 | D4C, GCX, NGL, NOE, NVE, PR2, PRO, PUR, RAD, RDW, SWF, SWP, TWN, V4I, ZDG, ZDW | PR2, PRO, PUR | — |
| IDC | 0 | — | — | — |
| GCX | 1 | NGL, RAD, RDW, SWF, TWN, ZDG, ZDW | D4C, NGL, NVE, NVL, PHS, RAD, RLS, SWF, SWP, T53, TWN, V4I, ZDG | GCX ≡ RAD ≡ ZDG |
| SWP | 1 | GCX, NGL, NOE, RAD, RDW, SWF, TWN, ZDG, ZDW | CRS, D4C, L26, LOC, NGL, NOE, NVE, NVL, PHS, PR2, PRO, PUR, RLS, SWF, T53, TWN, V4I | — |
| NVE | 1 | D4C, GCX, NGL, NOE, RAD, RDW, SWF, SWP, TWN, V4I, ZDG, ZDW | D4C, NVL, PHS, PR2, PRO, PUR, TWN | D4C ≡ NVE ≡ TWN |
| RDW | 0 | — | D4C, GCX, NGL, NVE, NVL, PHS, RAD, RLS, SWF, SWP, T53, TWN, V4I, ZDG | — |
| ZDW | 0 | — | D4C, GCX, NGL, NVE, NVL, PHS, RAD, RLS, SWF, SWP, T53, TWN, V4I, ZDG | — |
| SWF | 1 | GCX, NGL, NOE, RAD, RDW, SWP, TWN, ZDG, ZDW | D4C, GCX, NGL, NVE, NVL, PHS, RAD, RLS, SWP, T53, TWN, V4I, ZDG | — |

*Independence count: 196 of 351 pairs carry no dependence in either direction (S_3ed20b0e9c22).*