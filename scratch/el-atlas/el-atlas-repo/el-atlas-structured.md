...
*Perspective visibility — ADJ (executed, S_4b12572ead6c configs):*
...
*Verdict (S_4b12572ead6c, exhaustive): EXPRESSIBILITY-INTRINSIC — zero separators; co-movement 442368/442368 = 1.00; but GCX, RAD, RDW, ZDW is never F anywhere in the space: a theorem, truth-stable wherever statable. Mutual constitution at the statability level, one-way at the truth level: interventions de-state the theorem rather than falsify it. ∀-over-declared-spaces; open-by-design.*

*Separation ledger GCX–SWP:* separated-in-S_4b12572ead6c (0 truth-separators); unseparated in truth, 0/18432; kind counts carry the blanket-guard semantics @ S_f117b7f53a8e (165888, v3.5 first form — central complex V-guard overrode declared knob support; Break-2 coeff rows artifactual; retrospective R-V35); unseparated in truth 0/18432; theorem-cluster member @ S_2738ddb8c926 (165888, v3.5a corrected).


*Perspective visibility — GCX (executed, S_4b12572ead6c configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | P | P | P | P | P | P | P | P | P | P | V | P | P | P | V |

*Perspective visibility — RAD (executed, S_4b12572ead6c configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | P | P | P | P | P | P | P | P | P | P | V | P | P | P | V |

*Perspective visibility — RDW (executed, S_4b12572ead6c configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | P | P | P | P | P | P | P | P | P | P | V | P | P | P | V |

*Perspective visibility — ZDG (executed, S_4b12572ead6c configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | P | P | P | P | P | P | P | P | P | P | F | P | P | P | V |

*Perspective visibility — ZDW (executed, S_4b12572ead6c configs):*
...
*Verdict (S_4b12572ead6c, exhaustive): EXPRESSIBILITY-INTRINSIC — zero separators; co-movement 589824/589824 = 1.00; but NGL is never F anywhere in the space: a theorem, truth-stable wherever statable. Mutual constitution at the statability level, one-way at the truth level: interventions de-state the theorem rather than falsify it. ∀-over-declared-spaces; open-by-design.*


*Perspective visibility — NGL (executed, S_4b12572ead6c configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | V | P | P | P | P | P | P | V | P | P | V | P | P | P | V |

*Perspective visibility — V4I (executed, S_4b12572ead6c configs):*
...
*Perspective visibility — NOE (executed, S_4b12572ead6c configs):*
...
*Separation ledger NVE–NVL:* separated-in-S_4b12572ead6c (6144 truth-separators); separated, 6144 truth @ S_f117b7f53a8e (v3.5 first form, same caveat); separated, 6144 truth @ S_2738ddb8c926 (v3.5a).


*Perspective visibility — NVE (executed, S_4b12572ead6c configs):*
...
*Separation ledger SWF–SWP:* separated-in-S_4b12572ead6c (0 truth-separators); 0 truth / 36864 kind — exactly the statable complex region: the EXTENDS breaker's footprint as a separator count @ S_3ed20b0e9c22 (v3.6); 0 truth / 36864 kind — the EXTENDS footprint, stable across v3.6/v3.6a @ S_9a577e722039 (v3.6a).


*Perspective visibility — SWF (executed, S_4b12572ead6c configs):*
...
*Perspective visibility — SWP (executed, S_4b12572ead6c configs):*
...
*Perspective visibility — TWN (executed, S_4b12572ead6c configs):*
...
*Perspective visibility — IDC (executed, S_4b12572ead6c configs):*
...
*Separation ledger BAL–CDC:* separated-in-S_4b12572ead6c (165888 truth-separators); separated (adj; identical-frames) @ S_v2 (characteristic-break basis).


*Perspective visibility — BAL (executed, S_4b12572ead6c configs):*
...
*Separation ledger CDC–GCX:* separated-in-S_4b12572ead6c (110592 truth-separators); separated, 27648 truth — the sighting is not a restatement @ S_f117b7f53a8e (v3.5 first form, same caveat); separated, 27648 truth @ S_2738ddb8c926 (v3.5a).


*Perspective visibility — CDC (executed, S_4b12572ead6c configs):*
...
*Separation ledger CRS–NOE:* separated-in-S_4b12572ead6c (221184 truth-separators); unseparated-in-S_v3 @ S_v3 (9 knobs, no basis_def); separated (basis_def='singular') @ S_v2 (characteristic-break basis + basis_def probe).


*Perspective visibility — CRS (executed, S_4b12572ead6c configs):*
...
*Separation ledger PR2–PRO:* separated-in-S_4b12572ead6c (0 truth-separators); 0 truth-separators; 4096 kind-separators (PRO's guard keys on L1) @ S_94763a8b62ea (v3.3).


*Perspective visibility — PR2 (executed, S_4b12572ead6c configs):*
...
*Verdict (S_4b12572ead6c, exhaustive): EXPRESSIBILITY-INTRINSIC — zero separators; co-movement 516096/516096 = 1.00; but PRO is never F anywhere in the space: a theorem, truth-stable wherever statable. Mutual constitution at the statability level, one-way at the truth level: interventions de-state the theorem rather than falsify it. ∀-over-declared-spaces; open-by-design.*
...
*Perspective visibility — PRO (executed, S_4b12572ead6c configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | V | V | P | V | P | P | P | P | P | P | P | P | P | P | P |

*Perspective visibility — PUR (executed, S_4b12572ead6c configs):*
...
*Verdict (S_4b12572ead6c, exhaustive): TRUTH-INTRINSIC — zero separators of any kind; co-movement 497664/497664 = 1.00. Closure-under-break: every perturbation breaks the loop coherently, with kind-structure inside the co-movement (e.g. noisy lock: U vs F). ∀-over-declared-spaces; strengthens with each space survived; never closes.*
...
*Perspective visibility — L26 (executed, S_4b12572ead6c configs):*

| FULL | P1 | P2-I | CLASSICAL | PROB | NO-CODEC | NO-ANCHOR | ONE-OP | NO-NEG | SING-BASIS | NOISY-LOCK | CHAR-2 | SEDENION | SPHERE | MENTION | COMPLEX |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P | V | P | P | P | P | P | P | P | P | F | P | P | P | P | P |

*Perspective visibility — LOC (executed, S_4b12572ead6c configs):*
...
*Perspective visibility — RLS (executed, S_4b12572ead6c configs):*
...
*Perspective visibility — T53 (executed, S_4b12572ead6c configs):*
...
*Separation ledger PHS–TWN:* separated-in-S_4b12572ead6c (4608 truth-separators); SEPARATED: 768 truth-separators (the phase is the twist AS SEEN AGAINST the section) @ S_94763a8b62ea (v3.3).


*Perspective visibility — PHS (executed, S_4b12572ead6c configs):*
...
*Independence count: 195 of 351 pairs carry no dependence in either direction (S_4b12572ead6c).*