...
META = {
 ...
 'RDW': ("The radial witness mode", "At the sedenion rung, norm multiplicativity fails on pairs that are NOT zero divisors — the radial failure mode strictly exceeds the ZD mode.", "§5.9; theory-threads §14 (T2)"),
 'ZDW': ("The zero-divisor witness mode", "Every zero divisor at the sedenion rung is a norm-failure witness (N(xy)=0 below N(x)N(y)>0), and they exist — the contained witness mode.", "§5.9; theory-threads §14 (T2)"),
