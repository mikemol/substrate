...
open import Substrate.Groups.FreeCyclic-Coxeter-Strict2Monoid using (Coxeter-Strict2Monoid)
...
--
-- Coxeter-Strict2Monoid (the Strict2Monoid from Z₃-Coxeter) ×
...
Z3-x-F-Strict2Monoid =
  direct-product Coxeter-Strict2Monoid F-S2M.Coxeter-Strict2Monoid
