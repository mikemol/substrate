------------------------------------------------------------------------
-- Substrate.Groups.Capabilities.Strict2Monoid.Witness
--
-- ⟡witness-orbit-collapse. The five Zₙ witnesses of Strict2Monoid had byte-identical
...
open import Substrate.Groups.Capabilities.Strict2Monoid using (from-coxeter-data)
module Substrate.Groups.Capabilities.Strict2Monoid.Witness (n : ℕ) where
...
cap = from-coxeter-data Gen ++-assoc normalize normalize-distrib
