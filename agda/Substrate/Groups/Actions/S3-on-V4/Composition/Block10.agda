...
act-∙-canonical-10 {n₁} {n₂} c-n₁ c-n₂ v = trans LHS-to-pow (sym RHS-to-pow)
  where
    ...
    LHS-to-pow =
      trans (act-equals-pow (Z₃.normalize-canonical (Z₃.normalize (n₁ ++ Z₃.inv (Z₃.normalize n₂)))) (Z₂.c-pos (suc zero)) v)
    ...
    RHS-to-pow : act-on-canonical n₁ (Z₂.a ∷ []) (act-on-canonical n₂ [] v) ≡
                 rot-pow n₁ (swap-αβ (rot-pow n₂ v))
    RHS-to-pow =
      trans (act-equals-pow c-n₁ (Z₂.c-pos (suc zero)) (act-on-canonical n₂ [] v))
