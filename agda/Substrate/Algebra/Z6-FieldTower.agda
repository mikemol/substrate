...
mod3-of-6 (suc (suc zero))                                    = suc (suc zero)
mod3-of-6 (suc (suc (suc zero)))                              = zero
mod3-of-6 (suc (suc (suc (suc zero))))                        = suc zero
mod3-of-6 (suc (suc (suc (suc (suc zero)))))                  = suc (suc zero)
