...
--     • Substrate.Algebra.F2.Polynomial.Wedge.SBoxTable.sbox-is-aes           [AI-7s]
...
open import Substrate.Algebra.F2.AES.Round
  using (State; round; inv-round; final-round; inv-final-round; round-rt; final-round-rt) public

-- AI-12c — the cipher and its round-trip (round-key-parametric).
open import Substrate.Algebra.F2.AES.Cipher using (encrypt; decrypt; cipher-rt) public

-- AI-12k — the complete master-key cipher, key schedule, and round-trip.
open import Substrate.Algebra.F2.AES.KeySchedule
  using (keyExpansion; encrypt-key; decrypt-key; cipher-key-rt) public
