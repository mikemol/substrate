...
shift-hom (true , false) (true , true) =
  sym (sym-trans (+ⱽ-assoc sd-pair-01-23 sd-pair-01-23 sd-pair-02-13)
       (cong-trans (_+ⱽ sd-pair-02-13) (+ⱽ-self-inverse sd-pair-01-23)
...
shift-hom (false , true) (true , true) =
  sym (cong-trans (sd-pair-02-13 +ⱽ_) (+ⱽ-comm sd-pair-01-23 sd-pair-02-13)
      (sym-trans (+ⱽ-assoc sd-pair-02-13 sd-pair-02-13 sd-pair-01-23)
      (cong-trans (_+ⱽ sd-pair-01-23) (+ⱽ-self-inverse sd-pair-02-13)
...
shift-hom (true , true) (true , false) =
  sym (trans (+ⱽ-comm (sd-pair-01-23 +ⱽ sd-pair-02-13) sd-pair-01-23)
      (sym-trans (+ⱽ-assoc sd-pair-01-23 sd-pair-01-23 sd-pair-02-13)
      (cong-trans (_+ⱽ sd-pair-02-13) (+ⱽ-self-inverse sd-pair-01-23)
             (+ⱽ-identityˡ sd-pair-02-13))))
shift-hom (true , true) (false , true) =
  sym (trans (+ⱽ-assoc sd-pair-01-23 sd-pair-02-13 sd-pair-02-13)
      (cong-trans (sd-pair-01-23 +ⱽ_) (+ⱽ-self-inverse sd-pair-02-13)
