...
--
-- Coverage on the UP-site: a family of UPTermO morphisms into an object U is a
...
module _ (O : Set) (Hom : O → O → Set) where
  ...
  ------------------------------------------------------------------------
  -- UPCover: an indexed family of UPTermO morphisms into U.
  ------------------------------------------------------------------------
  ...
  record UPCover (U : O) : Set₁ where
    field
      Idx   : Set
      src   : Idx → O
      arrow : (i : Idx) → UPTermO O Hom (src i) U
