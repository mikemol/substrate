------------------------------------------------------------------------
-- Substrate.Category.UniversalProperty.ExtrudeCoEmitGraded.Bar
--
-- Defines: bar
...
module Substrate.Category.UniversalProperty.ExtrudeCoEmitGraded.Bar where
...
RealTrace.head (bar r) = pflip (RealTrace.head r)
